...
const ProjectCard = ({imgUrl,title,description,gitUrl,previewUrl}) => {
  return (
    <div>
      ...
      >
        <div className='overlay items-center justify-center gap-4 absolute top-0 left-0 w-full h-full hover:bg-[#181818] bg-opacity-0 hidden group-hover:flex group-hover:opacity-80 transition-all duration-300'>
